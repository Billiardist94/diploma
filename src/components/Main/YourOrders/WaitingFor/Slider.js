...
import { WAITING_FOR_RETURN_BOOKS } from '../../../../redux/actionCreator/waitingForReturnBooks';
            ...
            <div className="waiting-for_card-text">
              ...
              <div className="card-footer">
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    dispatch({ type: 'WAITING_FOR_RETURN_BOOKS', payload: item });
                  }}
                >
                  Return
                </button>
